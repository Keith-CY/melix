...
diff_from="${MELIX_BACKEND_IDENTITY_COVERAGE_DIFF_FROM:-origin/main}"
...
control_identity_test_filters=(
  ...
  'HTTPGatewayTests.RequestCoordinatorTests/identityMismatchStopsTrailingEventsBeforeReplay()'
  'HTTPGatewayTests.RequestCoordinatorTests/phaseAwareDecodeIdentityMismatchAfterPrefillIsNeverReplayed()'
