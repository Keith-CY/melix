...
public nonisolated struct Melix_Worker_V1_ChatToolCall: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Melix_Worker_V1_ChatMessage: Sendable {
  ...
  public var toolCalls: [Melix_Worker_V1_ChatToolCall] = []
...
nonisolated extension Melix_Worker_V1_ChatToolCall: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ChatToolCall"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}type\0\u{1}name\0\u{3}arguments_json\0")
  ...
  public static func ==(lhs: Melix_Worker_V1_ChatToolCall, rhs: Melix_Worker_V1_ChatToolCall) -> Bool {
...
nonisolated extension Melix_Worker_V1_ChatMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}role\0\u{1}name\0\u{1}parts\0\u{3}tool_calls\0\u{3}tool_call_id\0")
