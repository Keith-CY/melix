# Retrieval lookup payload nine-item copy fast path
...
common nine-item metadata lists and tuples in its lookup-copy workload. The
runtime change adds explicit nine-item list and tuple copy branches before the
existing eight-item specializations, preserving deep-copy isolation for nested
