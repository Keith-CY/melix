...
| [Window UI Product Spec](window-ui-product-spec.md) | Desktop operator window IA, object model, status model, routes, Inspector, security boundaries, and first-run UX |
...
| [Live Agent, MCP Approval, And Computer Use](plans/2026-07-31-live-agent-mcp-approval-computer-use.md) | Realtime Agent loop, trusted MCP tools, approval policy, reliable cancellation, evidence, and the isolated Computer Use broker |
