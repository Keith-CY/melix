...
| Plan | What It Covers |
|---|---|
| [Swift 6.3 CI Toolchain Baseline](plans/2026-08-07-swift-6-3-ci-toolchain-baseline.md) | Repository-owned Xcode 26.3 selection, Swift 6.3 verification, and compiler-isolated caches across macOS CI workflows |
