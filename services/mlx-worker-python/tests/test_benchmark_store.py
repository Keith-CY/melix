...
def test_benchmark_matrix_summary_skips_aggregation_when_requests_have_no_tool_turns() -> None:
    summary_rows = (
        build_benchmark_matrix_summary_row(
            job_id="bench-matrix-no-tools",
            task_kind="text-generation",
    ...
    assert (
        BenchmarkStore._attach_matrix_tool_turn_summary_fields(
            summary_rows=summary_rows,
            request_rows=request_rows,
        )
        is summary_rows
