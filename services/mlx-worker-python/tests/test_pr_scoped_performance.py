...
def test_registered_probes_expose_focused_commands() -> None:
    ...
    assert "test_metadata_payload_has_mlx_signal_does_not_sort_keys" in registry_probe.test_command
    ...
    assert "test_metadata_payload_has_mlx_signal_does_not_sort_keys" in registry_probe.coverage_command
