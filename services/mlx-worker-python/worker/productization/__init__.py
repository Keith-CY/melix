...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "AcceptanceRunConfig": (
        "worker.productization.swift_vision_real_model_acceptance",
        "AcceptanceRunConfig",
    ),
    "AcceptanceRunResult": (
        "worker.productization.swift_vision_real_model_acceptance",
    ...
    "MELIX_LOGICAL_PRODUCT_IDENTITY": (
        "worker.productization.packaging_targets",
        "MELIX_LOGICAL_PRODUCT_IDENTITY",
    ),
    ...
    "format_http_url_host": ("worker.productization.packaging_targets", "format_http_url_host"),
    ...
    "resolve_local_connect_host": ("worker.productization.packaging_targets", "resolve_local_connect_host"),
