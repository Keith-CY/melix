...
already-converted checkpoints by guarding the shift on the unsanitized conv1d
marker.
"""
...
def apply() -> bool:
    ...
    cls = q35vlm.Model
    if cls.__dict__.get("_melix_mtp_vlm_patched", False):
        _APPLIED = True
        return True

    def sanitize(self, weights):
        # Detect raw-HF input via unsanitized conv1d shape. Already-sanitized
        # checkpoints keep their norms unshifted.
    ...
    cls._melix_mtp_vlm_patched = True
    _APPLIED = True
