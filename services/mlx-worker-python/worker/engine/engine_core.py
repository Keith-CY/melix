...
def _usage_delta(
    *,
    ...
    prompt_tokens_value = non_negative_int(prompt_tokens)
    completion_tokens_value = non_negative_int(completion_tokens)
    cached_prompt_tokens_value = non_negative_int(cached_prompt_tokens)
    if not media_usage:
    ...
    return inference_pb2.UsageDelta(
        ...
        completion_tokens=completion_tokens_value,
        cached_prompt_tokens=cached_prompt_tokens_value,
        media_feature_cache_hits=non_negative_int(media_usage.get("media_feature_cache_hits", 0)),
        media_feature_cache_misses=non_negative_int(media_usage.get("media_feature_cache_misses", 0)),
        media_feature_encoder_calls_saved=non_negative_int(
            media_usage.get("media_feature_encoder_calls_saved", 0)
        ),
        media_feature_work_saved_bytes=non_negative_int(
