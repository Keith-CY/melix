...
struct TextDecodeEngine: Sendable {
    ...
    private func recordDecodeBatchProbeMetrics(_ probe: DecodeBatchProbeSummary?) {
        ...
        metrics.set("swift_text.decode_batch_token_eval_total_us", value: probe.decodeTokenEvalTotalMicros)
        metrics.set("swift_text.decode_batch_token_eval_call_count", value: probe.decodeTokenEvalCallCount)
        metrics.set("swift_text.decode_batch_token_eval_avg_us", value: probe.decodeTokenEvalAverageMicros)
