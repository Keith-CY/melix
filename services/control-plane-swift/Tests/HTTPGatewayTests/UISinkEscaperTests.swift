...
struct UISinkEscaperTests {
    ...
    func cssURLTokensQuoteSafeURLsAndBlockUnsafeSchemes() {
        ...
        #expect(UISinkEscaper.cssURLToken("images/category:search.png") == #"url("images/category:search.png")"#)
        #expect(UISinkEscaper.cssURLToken("style.css?v=1:2") == #"url("style.css?v=1:2")"#)
        #expect(UISinkEscaper.cssURLToken("1:2") == #"url("1:2")"#)
        #expect(UISinkEscaper.cssURLToken("H2TP://example.test/image.png") == #"url("about:blank")"#)
